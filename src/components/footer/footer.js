                        ...
                        <div className='row'>
                            <div className='col'>
                                <div className='box d-flex align-items-center w-100'>
                                    <span><img src="https://www.andindia.com/on/demandware.static/-/Sites-AND-Library/default/dw1880ebf3/images/footer-exchange/free-shipping.svg" /></span>
                                    <div className='info'>
                                        <h4>Free Shipping</h4>
                                        <p>On orders of INR 1499 and above</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='col'>
                                <div className='box d-flex align-items-center w-100'>
                                    <span><img src="https://www.andindia.com/on/demandware.static/-/Sites-AND-Library/default/dwe51fde0e/images/footer-exchange/easy-return.svg" /></span>
                                    <div className='info'>
                                        <h4>Easy Returns</h4>
                            ...
                            <div className='col'>
                                <div className='box d-flex align-items-center w-100'>
                                    <span><img src="https://www.andindia.com/on/demandware.static/-/Sites-AND-Library/default/dw8069b74d/images/footer-exchange/secure-payment.svg" /></span>
                                    <div className='info'>
